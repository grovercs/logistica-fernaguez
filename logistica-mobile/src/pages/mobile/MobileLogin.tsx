    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-primary/5 dark:bg-primary/10 p-8 text-center border-b border-primary/10">
                    ...
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Logística Fernaguez</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Portal del Técnico</p>
                </div>
                
                <div className="p-8">
                    {errorMsg && (
                        <div className="mb-4 p-3 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 text-rose-600 text-sm rounded-lg text-center font-semibold">
                            {errorMsg}
                        </div>
                    )}
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div>
                            <label className="block text-[11px] font-bold uppercase text-slate-500 dark:text-slate-400 tracking-wider mb-1.5">
