          ...
          <div className="w-full overflow-x-auto">
            <table className="w-full min-w-[960px] text-left">
              <thead className="bg-slate-50 dark:bg-slate-800/50 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                <tr><th className="px-5 py-4">Usuario</th><th className="px-5 py-4">Rol real</th><th className="px-5 py-4">Estado</th><th className="px-5 py-4">Trabajador vinculado</th><th className="px-5 py-4">&Uacute;ltimo acceso</th><th className="sticky right-0 z-20 min-w-[180px] border-l border-slate-200 bg-slate-50 px-5 py-4 text-right shadow-[-4px_0_8px_-6px_rgba(15,23,42,0.35)] dark:border-slate-700 dark:bg-slate-800">Acciones</th></tr>
              </thead>
